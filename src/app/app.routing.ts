...
export const AppRoutes: Routes = [
    ...
    { path: '', component: HomeComponent },
    {
        ...
        loadChildren: '../app/authenticate/authenticate.module#AuthenticateModule' 
    },
...

    {
        ...
        children: [
            ...
            { path: 'notifications', loadChildren: '../app/allnotification/allnotification.module#AllnotificationModule' ,canActivate: [AuthGuard]},
