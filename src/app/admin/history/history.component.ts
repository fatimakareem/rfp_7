...
export class HistoryComponent implements OnInit {
    ...
    constructor(private _serv1: HomeService,private authService: AuthService, private _nav: Router, private datePipe: DatePipe, private formBuilder: FormBuilder, private _serv: MainService, private Title: Title, private meta: Meta, private metaService: MetaService) {
    ...
    ngOnInit() {
        this.meta.updateTag({ name: 'twitter:title', content: 'Purchase History | ' + "RFP Gurus | Find RFP Bid Sites | Government Request for Proposal" });
